...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--delete-after", type=int, default=7,
        help="Days to retain completed jobs; 0 deletes immediately (default: 7)",
    )
    ...
    cron_edit.add_argument(
        "--delete-after", type=int,
        help="Days to retain completed jobs; 0 deletes immediately",
    )
